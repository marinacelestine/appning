...
database \cite{ma:2008}  & 3-4 months 		&					 	    \\%12-14 weeks
	 	  			&					&							\\
Inhouse 1	  & 34 lemurs 		& anat T2 			\\% Bruker 11.7 T
 	  &	15-60 months  	&							\\
	 	  &					&							\\
...
Anatomical images  pre-registered to 
...
\begin{center}
\label{fig:cbf}
\includegraphics[width=0.4\linewidth]{mean_cbf_mricron2.png}
\includegraphics[width=0.3\linewidth]{regional_cbf_4rois_black_bg.jpg}
...
Multimodal, multispecies\\
Demos on public small animal data
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
Optimized pipeline rerunning\\
Parallelization
\end{minipage}
