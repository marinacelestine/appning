...
The Python package sammba-MRI (http://sammba-mri.github.io) allows flexible and efficient use of existing methods:
fully and
...
\item T2 weighted scans from 34 mouse lemurs (15-60 months old) on 11.7 T
\item Bruker 11.7-FAIR EPI sequence from a group of 10 mice (5-7 months old)
\item BOLD EPI and T2 weighted 3DRARE from 15 mice (2-3 months old) from a public dataset
\end{itemize}
