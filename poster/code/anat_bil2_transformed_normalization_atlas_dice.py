...
if __name__ == '__main__':
    if os.path.expanduser('~') == '/home/bougacha':
        ...
        spm_template_atlas_file = os.path.join(
            ...
            'bil2_transformed', 'Average_atlas_invivo.nii')
        spm_dir = os.path.join(
            '/home/salma/appning_data/Pmamobipet/mrm_2010/reoriented',
            'bil2_transformed')
    else:
    ...
    sammba_dir = os.path.expanduser('~/mrm_bil2_transformed_preprocessed')
    sammba_raw_dir = os.path.expanduser('~/mrm_bil2_transformed')
...
#    anat_files.remove(os.path.expanduser(
#        '~/mrm_bil2_transformed/bil2_transfo_C57_ab2_invivo.nii.gz'))
#    anat_files.remove(os.path.expanduser(
